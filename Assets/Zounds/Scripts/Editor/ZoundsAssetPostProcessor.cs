...
namespace Zounds
{
    ...
    public class ZoundsAssetPostProcessor : AssetPostprocessor
    {
        ...
        {
            // Automatically get or create Addressable Asset Settings
            AddressableAssetSettings addressableSettings = AddressableAssetSettingsDefaultObject.GetSettings(true);

            if (addressableSettings == null)
            {
                Debug.LogError("[Zounds] Failed to initialize Addressable Asset Settings. Please create them manually via Window > Asset Management > Addressables > Groups.");
                return;
            }
