...
namespace Zounds {
    ...
    public class ZoundsAssetPostProcessor : AssetPostprocessor {
        ...
        public static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths) {
            ...
            // First check if they already exist to avoid the NRE during heavy imports
            AddressableAssetSettings addressableSettings = AddressableAssetSettingsDefaultObject.Settings;


            // If they don't exist, only try to create them if we actually have assets to process
